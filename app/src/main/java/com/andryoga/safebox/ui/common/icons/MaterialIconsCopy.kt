package com.andryoga.safebox.ui.common.icons

import androidx.compose.material.icons.materialIcon
import androidx.compose.material.icons.materialPath

object MaterialIconsCopy {
    val DeleteForeverFilled = materialIcon(name = "Filled.DeleteForever") {
        materialPath {
            moveTo(6.0f, 19.0f)
    ...
    val Visibility = materialIcon(name = "Filled.Visibility") {
        materialPath {
            moveTo(12.0f, 4.5f)
    ...
    val VisibilityOff = materialIcon(name = "Filled.VisibilityOff") {
        materialPath {
            moveTo(12.0f, 7.0f)
            curveToRelative(2.76f, 0.0f, 5.0f, 2.24f, 5.0f, 5.0f)
