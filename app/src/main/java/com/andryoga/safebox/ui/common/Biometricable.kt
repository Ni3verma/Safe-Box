...
interface Biometricable {
    ...
    fun configureBiometrics(fragment: Fragment, listener: Biometricable? = null)

    fun configureBiometrics(activity: FragmentActivity, listener: Biometricable? = null)

    fun showBiometricsAuthDialog(title: String, negativeButtonText: String)

    fun canUseBiometrics(): Boolean

    fun onBiometricEvent(event: BiometricableEventType)

    fun canUseBiometricsFeature(feature: BiometricsFeatureType, context: Context): Boolean
}
...
fun biometricableHandler() = object : Biometricable {
    ...
    override fun configureBiometrics(fragment: Fragment, listener: Biometricable?) {
        // Get main executor
    ...
    override fun configureBiometrics(activity: FragmentActivity, listener: Biometricable?) {
        // Get main executor
