...
import com.andryoga.safebox.common.AnalyticsKeys.BACKUP_SELECT_DIR_RESULT
import com.andryoga.safebox.common.AnalyticsKeys.RESULT
    ...
    private val selectBackupDirReq =
        registerForActivityResult(ActivityResultContracts.OpenDocumentTree()) { uri ->
            ...
            Firebase.analytics.logEvent(BACKUP_SELECT_DIR_RESULT) {
                param(RESULT, (uri != null && uri.path != null).toString())
            }
            if (uri != null) {
